...
$this->Attributes[] = new weTagData_choiceAttribute('type', array(new weTagDataOption('net', false, ''), new weTagDataOption('gros', false, ''), new weTagDataOption('vat', false, '')), false,false, '');
